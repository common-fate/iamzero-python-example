...
echo "[IAM ZERO]"
echo "[IAM ZERO] Make sure that you're using an active AWS profile"
echo "[IAM ZERO] export AWS_PROFILE=iamzero-test"
echo "[IAM ZERO]"
echo "[IAM ZERO] see https://iamzero.dev/docs/getting-started#creating-an-aws-user for more information"
